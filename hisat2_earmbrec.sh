...
##change following to batch after the course
...
##-x is the reference genome, provide path for that here (/databank/igenomes/Mus_musculus/Ensembl/GRCm38/Sequence/HISAT2/genome)
module load hisat2
hisat2 --threads 4 \
-x /databank/igenomes/Mus_musculus/Ensembl/GRCm38/Sequence/HISAT2/genome \
-1 ERR1755086_1.fastq.gz \
-2 ERR1755086_2.fastq.gz \
--rna-strandness RF \
